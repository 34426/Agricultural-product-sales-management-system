<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="爱心编号" prop="aixinbianhao">
            <el-input v-model="ruleForm.aixinbianhao" 
                placeholder="爱心编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.aixinbianhao" label="爱心编号" prop="aixinbianhao">
              <el-input v-model="ruleForm.aixinbianhao" 
                placeholder="爱心编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店家名" prop="dianjiaming">
          <el-input v-model="ruleForm.dianjiaming" 
              placeholder="店家名" clearable  :readonly="ro.dianjiaming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店家名" prop="dianjiaming">
              <el-input v-model="ruleForm.dianjiaming" 
                placeholder="店家名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="贫困认证" prop="pinkunrenzheng">
          <el-select v-model="ruleForm.pinkunrenzheng" placeholder="请选择贫困认证">
            <el-option
                v-for="(item,index) in pinkunrenzhengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="贫困认证" prop="pinkunrenzheng">
	      <el-input v-model="ruleForm.pinkunrenzheng"
                placeholder="贫困认证" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="贫困介绍" prop="pinkunjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.pinkunjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pinkunjieshao" label="贫困介绍" prop="pinkunjieshao">
                    <span v-html="ruleForm.pinkunjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='aixinbianhao'){
            this.ruleForm.aixinbianhao = obj[o];
	    this.ro.aixinbianhao = true;
            continue;
          }
          if(o=='diqu'){
	    ...
	    this.ro.diqu = true;
          ...
          if(o=='dianjiaming'){
            this.ruleForm.dianjiaming = obj[o];
	    this.ro.dianjiaming = true;
            continue;
          }
          if(o=='dizhi'){
	    ...
	    this.ro.dizhi = true;
          ...
          if(o=='pinkunrenzheng'){
            this.ruleForm.pinkunrenzheng = obj[o];
	    this.ro.pinkunrenzheng = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='pinkunjieshao'){
            this.ruleForm.pinkunjieshao = obj[o];
	    this.ro.pinkunjieshao = true;
            continue;
          }
          if(o=='thumbsupnum'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.pinkunrenzhengOptions = "是".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `aixinxiang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.pinkunjieshao = this.ruleForm.pinkunjieshao.replace(reg,'../../../springboot333w4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `aixinxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.aixinxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
