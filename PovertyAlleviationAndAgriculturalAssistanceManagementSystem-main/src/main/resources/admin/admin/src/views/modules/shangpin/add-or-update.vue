<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="生产地" prop="shengchandi">
          <el-select v-model="ruleForm.shengchandi" placeholder="请选择生产地">
            <el-option
                v-for="(item,index) in shengchandiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springboot333w4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
