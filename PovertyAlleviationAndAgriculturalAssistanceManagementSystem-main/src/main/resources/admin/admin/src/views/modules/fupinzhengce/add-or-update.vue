<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="政策名称" prop="zhengcemingcheng">
          <el-input v-model="ruleForm.zhengcemingcheng" 
              placeholder="政策名称" clearable  :readonly="ro.zhengcemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="政策名称" prop="zhengcemingcheng">
              <el-input v-model="ruleForm.zhengcemingcheng" 
                placeholder="政策名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布单位" prop="fabudanwei">
          <el-input v-model="ruleForm.fabudanwei" 
              placeholder="发布单位" clearable  :readonly="ro.fabudanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布单位" prop="fabudanwei">
              <el-input v-model="ruleForm.fabudanwei" 
                placeholder="发布单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="政策文件" prop="zhengcewenjian">
          <file-upload
          tip="点击上传政策文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhengcewenjian" label="政策文件" prop="zhengcewenjian">
            <el-button type="text" size="small" @click="download(ruleForm.zhengcewenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="政策介绍" prop="zhengcejieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhengcejieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhengcejieshao" label="政策介绍" prop="zhengcejieshao">
                    <span v-html="ruleForm.zhengcejieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhengcemingcheng = true;
          ...
          if(o=='fabudanwei'){
            this.ruleForm.fabudanwei = obj[o];
	    this.ro.fabudanwei = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='zhengcejieshao'){
            this.ruleForm.zhengcejieshao = obj[o];
	    this.ro.zhengcejieshao = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.zhengcejieshao = this.ruleForm.zhengcejieshao.replace(reg,'../../../springboot333w4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
