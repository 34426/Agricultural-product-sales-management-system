<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="店家名" prop="dianjiaming">
          <el-select v-model="ruleForm.dianjiaming" placeholder="请选择店家名">
            <el-option
                v-for="(item,index) in dianjiamingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
