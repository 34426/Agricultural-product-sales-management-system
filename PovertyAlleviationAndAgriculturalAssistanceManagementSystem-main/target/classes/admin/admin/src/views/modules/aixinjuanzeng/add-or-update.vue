<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠金额" prop="juanzengjine">
          <el-input v-model="ruleForm.juanzengjine" 
              placeholder="捐赠金额" clearable  :readonly="ro.juanzengjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠金额" prop="juanzengjine">
              <el-input v-model="ruleForm.juanzengjine" 
                placeholder="捐赠金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="捐赠说明" prop="juanzengshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="捐赠说明"
                  v-model="ruleForm.juanzengshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.juanzengshuoming" label="捐赠说明" prop="juanzengshuoming">
                    <span>{{ruleForm.juanzengshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.juanzengjine = true;
          ...
          if(o=='juanzengshuoming'){
            this.ruleForm.juanzengshuoming = obj[o];
	    this.ro.juanzengshuoming = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `aixinjuanzeng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.aixinjuanzengCrossAddOrUpdateFlag = false;
                  this.parent.search();
